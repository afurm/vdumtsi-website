...
export const formats: MasterclassFormat[] = [
  ...
  },
  {
    ...
    summary:
      "Організований майстер‑клас для команди або події: простір, матеріали, пакування та ритм групи.",
    bestFor: ["корпоративів", "командних подій", "свят", "бренд‑івентів"],
    accent:
      "Діапазон ціни залежить від теми, сезону, кількості учасників і складності матеріалів.",
  },
];
...
export const certificate = {
  ...
  note:
    "Деталі друкованого або електронного сертифіката, оплату та отримання погоджуємо при оформленні.",
};
...
export const includedItems = [
  "усі квіти та матеріали",
  "аквабокси або пакування",
  "текстиль та підготовка простору",
  "пояснення та практика під час майстер‑класу",
