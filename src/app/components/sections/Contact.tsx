...
const contactMethods = [
  ...
  },
  {
    ...
    value: email,
    href: `mailto:${email}`,
    description: "Для запитів корпоративних клієнтів, договорів і деталей події.",
  },
  {
    title: "Адреса студії",
    value: address,
        ...
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-text-secondary">
              ...
              учасників, тему та доступну дату. Для корпоративних клієнтів
              підготуємо окремі умови, безготівковий розрахунок і договір.
            </p>
            ...
            <div className="mt-8 rounded-lg border border-dark-green/20 bg-white p-6">
              ...
              <ul className="mt-5 space-y-3 text-sm leading-6 text-text-secondary">
                ...
                <li>Для корпоративних клієнтів доступний безготівковий розрахунок.</li>
              </ul>
            </div>
